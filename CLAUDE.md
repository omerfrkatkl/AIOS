...
- **Personal-data freeze (owner decision 2026-08-25):** during platform construction collect NO new personal data and run NO interview rounds; the existing PROFILE stays intact (never wiped); tests use synthetic fixtures or TEST-tagged data only. The full personal campaign resumes at system completion (PLAN §3.5 item 5).
